...
namespace Verse.Sound {
 ...
 public class Sustainer{public bool Ended; public SoundInfo info; public void Maintain(){} public void End(){Ended=true;}}
}
...
namespace Verse {
 ...
 public static class Scribe_Values {
  public static void Look<T>(ref T v, string key, T fallback=default) {
 ...
 public static partial class VectorStubExtensions {
 ...
 public partial class ThingDef{public ProjectileProperties projectile=new(); public List<ThingCategoryDef> thingCategories = new();}
 // def lives on Thing in the engine, and Rounds reads it there.
 public partial class Thing{public bool Destroyed,Spawned=true; public Map Map; public ThingDef def=new();}
 public partial class Pawn:Thing {
  public bool Dead; public float BodySize = 1f;
  public Verse.AI.Pawn_PathFollower pather; public Pawn(){pather=new(this);} public Stances stances = new(); public float Damage;
 ...
 public partial class Stances { public Stagger stagger = new(); }
 ...
 public partial class Projectile:Thing {
...
namespace RimArt {
 ...
 public static class RecursionRegistry { public static int CapturedCount; public static System.Collections.Generic.HashSet<Verse.Thing> Held=new(); public static bool TryGetCapture(Verse.Thing t, out HalvingProjectile o) { o=null; return Held.Contains(t); } }
}
...
namespace CombatExtended {
 ...
 public partial class ProjectileCE : Verse.Thing {
