...
| World v2 (plates with depth, tiers past the edge, the sky) | sketches only | not ported; an experiment, not agreed |
...
and the terrain fallback, from the lab's own formulas. The swords' pictures are not shipped: in the
...
- The frame rate with about 930 swords baked (about 35 draws a frame while the world stands, more
  while the fire runs out).
