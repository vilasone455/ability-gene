...
namespace RimArt
{
    ...
    /// world beside the map on screen and plays the fire running out; "world map: close" runs the white in
    /// and removes it; "world map: close now" removes it at once.
    /// </summary>
    public static class DebugActions_UbwMap
    {
        ...
        public static void Open()
        {
            ...
            UnlimitedBladeWorksMap.OpenLater(source, new List<IntVec3> { IntVec3.Zero });
        }
