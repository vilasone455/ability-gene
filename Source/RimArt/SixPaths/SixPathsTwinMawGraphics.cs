...
namespace RimArt
{
    ...
    public static class SixPathsTwinMawGraphics
    {
        ...
        private static readonly Mesh armedRing = VfxDraw.Ring(0.95f, "Six Paths maw armed ring");
        private static readonly Mesh disc = VfxDraw.Ring(0f, "Six Paths maw socket");
