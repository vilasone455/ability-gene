...
namespace RimArt
{
    ...
    /// other answer this mod gives to incoming damage is a transformation of it - vector
    /// manipulation turns the round around, the phase barrier scales it toward zero, and the
    /// arrears ledger defers it in full. Scatter is the exemption those three are all
