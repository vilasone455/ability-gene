    ...
    public static class InvoluteUtility
    {
        ...
        public static BodyPartRecord RollHolePart(Pawn pawn, InvoluteGeneExtension ext)
        {
            ...
            if (ext != null && ext.forceHolePart != null)
            {
                ...
                Log.WarningOnce("[AbilityGenes] Involute organ: forceHolePart " + ext.forceHolePart.defName
        ...
        public static Map GenerateVolume(Gene_Involute gene)
        {
            ...
            if (generator == null)
            {
                Log.ErrorOnce("[AbilityGenes] Involute organ has no volumeGenerator on its gene def.", 0x1CF01E);
                return null;
            }
