...
// Trail parcels spread and fall from their emission times; tangent-based width holds in all facings. Steam uses the Six Paths Puff texture.
import { Color, Mathf } from '../js/engine.js';
import { P, Y, Floor, sprite, circle, glow, soft } from './lib/six-paths-impact.js';
import { drawWaterGun, frame, figure, flames, steam, puddle, drips, splash, stream, streamTrail, bump, WaterLit, Water, HandH, Lead, Raise, Lower, Tail } from './lib/water-gun.js';
